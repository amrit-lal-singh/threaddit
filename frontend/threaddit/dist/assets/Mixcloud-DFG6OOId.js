import { w as _, r as f } from './index-D2fKRnGh.js';
import { u as m, p as g } from './Post-tTD_BayB.js';
function v(t, e) {
...
class l extends u.Component {
  constructor() {
    super(...arguments),
      a(this, 'callPlayer', p.callPlayer),
  ...
  render() {
    const { url: e, config: r } = this.props,
      ...
      n = (0, p.queryString)({ ...r.options, feed: `/${s}/` });
...
a(l, 'loopOnEnded', !0);
const T = _(h),
  A = v({ __proto__: null, default: T }, [h]);
export { A as M };
