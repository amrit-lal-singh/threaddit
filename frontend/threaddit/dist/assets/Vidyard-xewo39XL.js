import { w as g, r as v } from './index-D2fKRnGh.js';
import { u as b, p as O } from './Post-tTD_BayB.js';
function V(t, e) {
...
class y extends c.Component {
  ...
  load(e) {
    const { playing: r, config: o, onError: a, onDuration: i } = this.props,
...
const T = g(f),
  B = V({ __proto__: null, default: T }, [f]);
export { B as V };
