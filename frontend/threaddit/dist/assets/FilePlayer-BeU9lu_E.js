import { w as b, r as _ } from './index-D2fKRnGh.js';
import { u as O, p as A } from './Post-tTD_BayB.js';
function R(s, e) {
...
class P extends d.Component {
  ...
  componentDidMount() {
    ...
    e && (this.player.src = e),
      (v || this.props.config.forceDisableHls) && this.player.load();
  }
  ...
  shouldUseHLS(e) {
    return (V && this.props.config.forceSafariHLS) || this.props.config.forceHLS
      ? !0
      : v || this.props.config.forceDisableHls
        ? !1
...
const z = b(g),
  Q = R({ __proto__: null, default: z }, [g]);
export { Q as F };
