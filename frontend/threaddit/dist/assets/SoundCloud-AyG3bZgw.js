import { w as P, r as g } from './index-D2fKRnGh.js';
import { u as b, p as v } from './Post-tTD_BayB.js';
function O(t, e) {
...
var S = Object.create,
  ...
  a = (t, e, r) => (D(t, typeof e != 'symbol' ? e + '' : e, r), r),
  h = {};
L(h, { default: () => u });
var f = R(h),
  p = M(g),
...
class u extends p.Component {
  constructor() {
    super(...arguments),
      a(this, 'callPlayer', c.callPlayer),
      a(this, 'duration', null),
      a(this, 'currentTime', null),
      a(this, 'fractionLoaded', null),
      a(this, 'mute', () => {
        this.setVolume(0);
      }),
      a(this, 'unmute', () => {
    ...
    (0, c.getSDK)(N, x).then((s) => {
      ...
      r ||
        ...
        this.player.bind(n, (i) => {
          (this.currentTime = i.currentPosition / 1e3),
            (this.fractionLoaded = i.loadedProgress);
        }),
        this.player.bind(_, () => this.props.onEnded()),
        this.player.bind(m, (i) => this.props.onError(i))),
        this.player.load(e, {
...
a(u, 'loopOnEnded', !0);
const A = P(f),
  I = O({ __proto__: null, default: A }, [f]);
export { I as S };
