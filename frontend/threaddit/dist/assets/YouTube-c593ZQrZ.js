import { w as U, r as I } from './index-D2fKRnGh.js';
import { u as L, p as M } from './Post-tTD_BayB.js';
function Y(a, e) {
...
var k = Object.create,
  ...
  s = (a, e, t) => (x(a, typeof e != 'symbol' ? e + '' : e, t), t),
  w = {};
K(w, { default: () => O });
var S = H(w),
  m = F(I),
        ...
        const { data: t } = e,
          {
            ...
            onReady: g,
            loop: y,
            config: { playerVars: l, onUnstarted: h },
          } = this.props,
          {
            UNSTARTED: d,
            PLAYING: c,
