import { w as P, _ as E, r as g } from './index-D2fKRnGh.js';
import { p as _ } from './Post-tTD_BayB.js';
function b(r, e) {
...
class l extends v.Component {
  ...
  render() {
    ...
    return (
      s === !1 && (d['--controls'] = 'none'),
      v.default.createElement('mux-player', {
        ref: this.ref,
...
const C = P(m),
  T = b({ __proto__: null, default: C }, [m]);
export { T as M };
