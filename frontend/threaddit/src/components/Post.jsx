    ...
    <>
      ...
      >
        {post.post_info.media && (
          <div
            className={`relative overflow-hidden ${isExpanded ? 'h-full md:h-96' : 'md:w-64 md:h-32'} md:pt-0 ${
          ...
          <div className="flex flex-col space-y-1 w-full md:justify-between">
            {isExpanded ? (
              <div className="flex flex-col space-y-2 w-full h-full">
                <div
                  className={`w-full font-semibold text-ellipsis ${post.post_info.content && 'border-b-2 pb-2'}`}
                >
        ...
        <div
          className={`flex ${isExpanded && 'items-center justify-between mx-5 md:-mt-4'}`}
        >
          <div
