    ...
    >
      ...
      <div className="flex justify-around items-center md:justify-between md:mx-10">
        ...
        >
          <Svg
            type="down-arrow"
            className={`w-4 h-4 ${expandChildren && 'rotate-180'}`}
          />
          <p className="text-sm cursor-pointer md:text-base">
            {expandChildren ? 'Hide' : 'Show'}
          </p>
        </div>
    ...
    >
      ...
      >
        ...
        <div className="flex self-end space-x-2">
          <button
            type="submit"
            className="px-2 py-1 font-bold text-white bg-blue-600 rounded-md md:px-5"
          >
            Submit
          </button>
          <button
